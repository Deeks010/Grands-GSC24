...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/health',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Health')
              : const HealthWidget(),
        ),
        FFRoute(
          name: 'Messages',
        ...
        FFRoute(
          ...
          path: '/discover',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'Discover')
        ...
        FFRoute(
          name: 'ai_chatbot',
          path: '/aiChatbot',
          builder: (context, params) => const AiChatbotWidget(),
        ),
        FFRoute(
          name: 'landingpage',
          path: '/landingpage',
        ...
        FFRoute(
          ...
          path: '/aiChatbotCopy',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'ai_chatbotCopy')
              : const AiChatbotCopyWidget(),
        )
